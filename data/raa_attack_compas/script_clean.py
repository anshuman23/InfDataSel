...
X_tr_c, Y, S = np.load('raa_attack_data/X_train_clean.npy'), np.load('raa_attack_data/y_train_clean.npy'), np.load('raa_attack_data/s_train_clean.npy')
...
X_te_c, Y, S = np.load('raa_attack_data/X_test.npy'), np.load('raa_attack_data/y_test.npy'), np.load('raa_attack_data/s_test.npy')
